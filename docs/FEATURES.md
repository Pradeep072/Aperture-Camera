...
| **Dual Camera Screen** | Picture-in-Picture dual camera preview for simultaneous front + rear capture with camera tag badge and stream swap on supported devices. | [`DualCameraScreen.kt`](../app/src/main/java/com/aperture/camera/ui/screens/DualCameraScreen.kt)<br>`com.aperture.camera.ui.screens.DualCameraScreen` |
| **Front Camera Punch-Hole Halo Overlay** | Detects hardware `DisplayCutout` and renders an animated 360° golden sweep arc, radial glow pulse, and active selfie countdown progress ring around the physical front camera lens. | [`FrontCameraHaloOverlay.kt`](../app/src/main/java/com/aperture/camera/ui/components/FrontCameraHaloOverlay.kt)<br>`com.aperture.camera.ui.components.FrontCameraHaloOverlay` |
| **Shutter Flash Overlay** | High-speed white screen flash providing instantaneous visual capture feedback over the viewfinder. | [`ShutterFlashOverlay.kt`](../app/src/main/java/com/aperture/camera/ui/components/ShutterFlashOverlay.kt)<br>`com.aperture.camera.ui.components.ShutterFlashOverlay` |
| **Sound & Haptics Manager** | Coordinates system shutter audio sound effects and subtle haptic feedback pulses on capture. | [`CameraSoundAndHapticsManager.kt`](../app/src/main/java/com/aperture/camera/camera/CameraSoundAndHapticsManager.kt)<br>`com.aperture.camera.camera.CameraSoundAndHapticsManager` |
