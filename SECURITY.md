...
3. Include as much information as possible:
   ...
   - Any proof-of-concept code or logcat output.

### Response Timeline
- We will acknowledge receipt of your vulnerability report within **48 hours**.
- We will provide an assessment and estimated timeline for a security fix within **5 business days**.
- Once a fix is verified, a patch release will be published along with appropriate security credit to the reporter.
